...
public class BossHealth2 : EnemyHealth
{
    ...
    {
        if (BossStateManager2.Instance != null && BossStateManager2.Instance.IsVulnerable && !isDead)
        {
    ...
    {
        if (bossImage != null && BossStateManager2.Instance != null)
        {
            Color targetColor = BossStateManager2.Instance.IsVulnerable ? vulnerableColor : invulnerableColor;
